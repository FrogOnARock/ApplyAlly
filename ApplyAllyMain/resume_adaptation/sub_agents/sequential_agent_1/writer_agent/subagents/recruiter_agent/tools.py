"""
Tools for Recruiter Agent

This module provides tools for analyzing and validating applicant resumes.
"""
...
def count_characters(text: str, tool_context: ToolContext) -> Dict[str, Any]:
    ...
    if char_count < MIN_LENGTH:
        ...
        return {
            ...
            "message": f"Resume is too short. Add {chars_needed} more characters to reach minimum length of {MIN_LENGTH}.",
        }
        ...
        return {
            ...
            "message": f"Resume is too long. Remove {chars_to_remove} characters to meet maximum length of {MAX_LENGTH}.",
        }
    else:
        ...
        return {
            "result": "pass",
            "char_count": char_count,
            "message": f"Resume length is good ({char_count} characters).",
        }


def exit_loop(tool_context: ToolContext) -> Dict[str, Any]:
    """
    Call this function ONLY when the resume meets all quality requirements,
    ...
    """
    print("\n----------- EXIT LOOP TRIGGERED -----------")
    print("Resume review completed successfully")
